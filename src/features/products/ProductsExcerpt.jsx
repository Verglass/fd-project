            ...
            <div className='flex justify-between'>
                ...
                <div className='text-right w-fit shrink-0 p-5 flex flex-col justify-between'>
                    ...
                    <div className='flex flex-col items-end py-5 gap-y-5'>
                        ...
                        {admin && <button className='w-fit bg-zinc-700 hover:bg-zinc-600 text-zinc-50 p-2 rounded' onClick={() => {dispatch(fetchComments(product._id)); setCommentsActive(!commentsActive)}}>{polish ? 'Przełącz komentarze' : 'Toggle comments'}</button>}
                    </div>
                </div>
            </div>
